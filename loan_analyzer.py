...
print (f"The total value of the loans is", total)
...
print (f"The average loan amount of this list is", round(average, 2))
...
# YOUR CODE HERE!
def calculate_present_value (future_value, new_remaining_months, annual_discount_rate):
    present_value = future_value / (1 + annual_discount_rate/12) ** new_remaining_months
...
present_value = calculate_present_value (future_value, new_remaining_months, annual_discount_rate)
